...
## Задание (часть I: практика)

Реализуйте методы `AcquireForks` и `ReleaseForks` в файле [`philosopher.cpp`](source/philosopher.cpp) таким образом, чтобы дэдлок гарантированно не мог возникнуть.
...
Если `AcquireForks` написан аккуратно, то в **каждом достижимом состоянии** по крайней мере у одного из философов будет возможность получить обе вилки независимо от поведения других философов.
...
Оригинальная задача нам не интересна, из нее взят только сеттинг. 